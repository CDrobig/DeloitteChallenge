...
#todo: extract imbalanced classes and implement logic to find out how many rows to generate
#todo: import and restructure utility functions from the notebook
#find notebook for detailed information and evaluation of the GAN here:
...
class DenseDiscriminator(torch.nn.Module):
